    ...
    $.ajax(settings).done(function(response) {
        ...
        $.each(response, function(i, item) {
            ...
            const finishBtnDisabled =
                ...
                item[0] +
                ')>FINISH</button><button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="sr-only">Toggle Dropdown</span><div class="dropdown-menu"><a class="dropdown-item" onclick="handleUnfinish(' +
                item[0] +
                ')">Unfinish</a></div></div>';
